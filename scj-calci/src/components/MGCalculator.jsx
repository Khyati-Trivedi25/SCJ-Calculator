  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-neutral-900 rounded-xl shadow text-white">
      ...
      <form className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4" onSubmit={e => { e.preventDefault(); calculateRevenue(); }}>
        {adTypes.map((type) => (
          <div key={type + "-imp"} className="flex items-center gap-2 p-2 border border-neutral-700 rounded bg-neutral-900 h-12 min-w-[220px]">
        ...
        <div className="flex items-center gap-2 p-2 border border-neutral-700 rounded bg-neutral-900 h-12 md:col-span-2 min-w-[220px]">
          <span className="font-medium text-gray-300 min-w-[120px] text-sm">Minimum Guarantee</span>
          <input
            type="number"
      ...
      {results && (
        <div className="mt-8 space-y-3">
          ...
          <div className="flex items-center gap-3">
            <span className="font-bold text-gray-300 min-w-[160px]">Gross Revenue (incl. MG):</span>
